                    ...
                    <div class="card o-hidden border-0 shadow-lg my-5">
                        <div class="card-body p-0">
                            ...
                            <div class="centertext">
                                <div class="p-5">
                                    <h1 class="h4 text-gray-900 mb-4" id="login-text">Isi Data Diri</h1>
                                <form class="user" method="POST" action="{{ route('inputInfo') }}">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user"
                                            id="alamatLengkap" name="alamat" placeholder="Alamat Lengkap"
                                            required>

                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user"
                                            id="nomorTelepon" name="no_telp" placeholder="Nomer Telepon"
                                            required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" id="kewarganegaraan" name="kewarganegaraan"
                                            required>
                                            <option value="" selected="selected" disabled>Pilih Kewarganegaraan
                                            </option>
